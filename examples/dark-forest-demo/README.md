...
```bash
cd examples/dark-forest-demo && pnpm install
...
```typescript
import { verifyEscrow, reportQuality } from '@kamiyo/dark-forest-inference';
...
```typescript
import { verifyReputationProof } from '@kamiyo/dark-forest-privacy';
